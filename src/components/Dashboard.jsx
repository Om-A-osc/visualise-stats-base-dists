  ...
  return (
    <>
      ...
      <aside className="sidebar panel">
        <div>
          <p className="eyebrow">Configuration Panel</p>
          <h2 className="sidebar-title">Parameters & Controls</h2>
          <p className="lede">
            Adjust distribution parameters and watch visualizations update in real-time.
          </p>
        </div>
    ...
    <ReadmePanel distributionKey={selectedKey} config={config} />
    </>
  );
}
